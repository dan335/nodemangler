...
async fn main() {
    ...
    use mangler_core::operations::images::filter::smoothing::anisotropic_diffusion::OpImageAdjustmentAnisotropicDiffusion;
    use mangler_core::operations::images::filter::stylize::anisotropic_kuwahara::OpImageAdjustmentAnisotropicKuwahara;
    use mangler_core::operations::images::filter::smoothing::bilateral::OpImageAdjustmentBilateral;
    use mangler_core::operations::images::filter::edges::canny::OpImageAdjustmentCanny;
    use mangler_core::operations::images::filter::edges::dog::OpImageAdjustmentDog;
    use mangler_core::operations::images::filter::morphology::erode::OpImageAdjustmentErode;
    use mangler_core::operations::images::filter::smoothing::guided::OpImageAdjustmentGuided;
    use mangler_core::operations::images::filter::stylize::kuwahara::OpImageAdjustmentKuwahara;
    use mangler_core::operations::images::filter::smoothing::median::OpImageAdjustmentMedian;
    use mangler_core::operations::images::filter::smoothing::non_local_means::OpImageAdjustmentNonLocalMeans;
    use mangler_core::operations::images::filter::stylize::oil_paint::OpImageAdjustmentOilPaint;
    use mangler_core::operations::images::filter::morphology::open::OpImageAdjustmentOpen;
    use mangler_core::operations::images::filter::smoothing::snn::OpImageAdjustmentSnn;
    use mangler_core::operations::images::filter::stylize::toon::OpImageAdjustmentToon;
    use mangler_core::operations::images::filter::morphology::vector_morphology::OpImageAdjustmentVectorMorphology;
    ...
    use mangler_core::operations::images::noise::basic::blue_noise::OpImageNoiseBlue;
    use mangler_core::operations::images::noise::fractal::curl::OpImageNoiseCurl;
    use mangler_core::operations::images::noise::process::erosion::OpImageNoiseErosion;
    use mangler_core::operations::images::noise::basic::gabor::OpImageNoiseGabor;
