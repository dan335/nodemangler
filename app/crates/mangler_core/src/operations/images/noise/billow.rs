...
//!
//! Produces a grayscale image using billow noise, a fractal noise variant that
//! takes the absolute value of each octave before summing, creating a puffy,
//! cloud-like appearance with soft ridges.
...
/// Operation that generates a grayscale image from billow noise.
