...
operations! {
    ...
    OpImageNoiseLeaks(crate::operations::images::noise::leaks::OpImageNoiseLeaks),
    OpImageNoiseStains(crate::operations::images::noise::stains::OpImageNoiseStains),
    OpImageNoisePeeling(crate::operations::images::noise::peeling::OpImageNoisePeeling),
    OpImageNoiseSmear(crate::operations::images::noise::smear::OpImageNoiseSmear),
    OpImageNoiseGrowth(crate::operations::images::noise::growth::OpImageNoiseGrowth),
    OpImageNoiseCaustics(crate::operations::images::noise::caustics::OpImageNoiseCaustics),
    OpImageNoiseVeins(crate::operations::images::noise::veins::OpImageNoiseVeins),
    OpImageNoiseWarpedRings(crate::operations::images::noise::warped_rings::OpImageNoiseWarpedRings),
    OpImageNoiseCreased(crate::operations::images::noise::creased::OpImageNoiseCreased),
    OpImageNoiseLightning(crate::operations::images::noise::lightning::OpImageNoiseLightning),
