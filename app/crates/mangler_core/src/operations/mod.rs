...
operations! {
    ...
    OpImageInputRaw(crate::operations::images::inputs::raw::OpImageInputRaw),
    ...
    OpImageAdjustmentDenoise(crate::operations::images::filter::smoothing::denoise::OpImageAdjustmentDenoise),
    ...
    OpImageAdjustmentExposure(crate::operations::images::adjustments::exposure::OpImageAdjustmentExposure),
    OpImageAdjustmentVibrance(crate::operations::images::adjustments::vibrance::OpImageAdjustmentVibrance),
    OpImageAdjustmentBlackWhite(crate::operations::images::adjustments::black_white::OpImageAdjustmentBlackWhite),
    OpImageAdjustmentPhotoFilter(crate::operations::images::adjustments::photo_filter::OpImageAdjustmentPhotoFilter),
    OpImageAdjustmentGrain(crate::operations::images::adjustments::grain::OpImageAdjustmentGrain),
    ...
    let mut list = vec![
        ...
        OperationListItem::Category { name: "images".to_string(), operation_list_items: vec![
            OperationListItem::Category { name: "input".to_string(), operation_list_items: vec![
                ...
                OperationListItem::Operation { operation: Operation::OpImageInputRaw },
            ...
            OperationListItem::Category { name: "adjustments".to_string(), operation_list_items: vec![
                ...
                OperationListItem::Operation { operation: Operation::OpImageAdjustmentVibrance },
                OperationListItem::Operation { operation: Operation::OpImageAdjustmentPhotoFilter },
                OperationListItem::Operation { operation: Operation::OpImageAdjustmentGrain },
                OperationListItem::Operation { operation: Operation::OpImageAdjustmentClarity },
                OperationListItem::Operation { operation: Operation::OpImageAdjustmentTexture },
                OperationListItem::Operation { operation: Operation::OpImageAdjustmentDehaze },
                OperationListItem::Operation { operation: Operation::OpImageAdjustmentColorLookup },
                ...
                OperationListItem::Operation { operation: Operation::OpImageAdjustmentToneEqualizer },
            ...
            OperationListItem::Category { name: "filter".to_string(), operation_list_items: vec![
                ...
                OperationListItem::Category { name: "smoothing".to_string(), operation_list_items: vec![
                    ...
                    OperationListItem::Operation { operation: Operation::OpImageAdjustmentDenoise },
