...
impl OpImageNoiseHeterogenousMultifractalNoise {
    pub fn settings() -> NodeSettings {
        NodeSettings {
            ...
            description: "Creates a heterogenous multifractal noise image.".to_string(),
        }
    }
    ...
    pub async fn run(inputs: &mut Vec<Input>) -> Result<OperationResponse, OperationError> {
        ...
        let basicmulti = BasicMulti::<Perlin>::new(seed as u32).set_frequency(frequency as f64).set_octaves(octaves as usize).set_lacunarity(lacunarity as f64).set_persistence(persistence as f64);
...
mod tests {
    ...
    #[tokio::test]
    async fn test_opimagenoiseheterogenousmultifractalnoise_settings() {
        let s = OpImageNoiseHeterogenousMultifractalNoise::settings();
        assert_eq!(s.name, "basic multifractal noise");
    ...
    #[tokio::test]
    async fn test_opimagenoiseheterogenousmultifractalnoise_run() {
        let mut inputs = vec![
    ...
    #[tokio::test]
    async fn test_opimagenoiseheterogenousmultifractalnoise_correct_dimensions() {
        let mut inputs = vec![
