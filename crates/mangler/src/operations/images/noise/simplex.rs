...
impl OpImageNoiseSimplex {
    ...
    pub fn settings() -> NodeSettings {
        NodeSettings {
            ...
            description: "Creates an image from simplex noise.".to_string(),
        }
    }
    ...
    pub async fn run(inputs: &mut Vec<Input>) -> Result<OperationResponse, OperationError> {
        ...
        let perlin = Simplex::new(seed as u32);
...
mod tests {
    ...
    #[tokio::test]
    async fn test_opimagenoisesimplex_settings() {
        let s = OpImageNoiseSimplex::settings();
        assert_eq!(s.name, "simplex noise");
    ...
    #[tokio::test]
    async fn test_opimagenoisesimplex_run() {
        let mut inputs = vec![
        ...
        let result = OpImageNoiseSimplex::run(&mut inputs).await;
    ...
    #[tokio::test]
    async fn test_opimagenoisesimplex_correct_dimensions() {
        let mut inputs = vec![
    ...
    #[tokio::test]
    async fn test_opimagenoisesimplex_1x1() {
        let mut inputs = vec![
            Input::new("seed".to_string(), Value::Integer(1), None, None),
        ...
        let result = OpImageNoiseSimplex::run(&mut inputs).await;
        assert!(result.is_ok(), "1x1 simplex failed: {:?}", result.err());
    }
