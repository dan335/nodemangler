//! Hyperbolic tangent operation for the node graph.
//!
...
/// Node operation that computes the hyperbolic tangent of a value.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct OpNumberTrigTanh {}

impl OpNumberTrigTanh {
    ...
    /// Executes the hyperbolic tangent operation.
