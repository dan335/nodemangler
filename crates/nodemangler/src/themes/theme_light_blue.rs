...
pub fn theme_light_blue() -> ThemeValues 
{
    ...
    ThemeValues {
        ...
        grid_connection_dot_disabled: Hsva::new(0.565, 0.81, 0.67, 1.0).into(),
        ...
        widgets_noninteractive_fg_stroke: (1.0, Hsva::new(0.565, 0.15, 0.9, 1.0).into()),
        ...
        widgets_interactive_fg_stroke: (1.0, Hsva::new(0.565, 0.15, 0.9, 1.0).into()),
        ...
        widgets_hovered_fg_stroke: (1.0, Hsva::new(0.565, 0.15, 0.9, 1.0).into()),
        ...
        widgets_active_fg_stroke: (1.0, Hsva::new(0.565, 0.15, 0.9, 1.0).into()),
        ...
        widgets_open_fg_stroke: (1.0, Hsva::new(0.565, 0.15, 0.9, 1.0).into()),
